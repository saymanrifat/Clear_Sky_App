        ...
        viewModelWeather.getWeatherData(edTextStr).observe(requireActivity()) {
            when (it) {
                ...
                is ResultData.Failed -> {
                    ...
                    Toast.makeText(context, "No Weather Data", Toast.LENGTH_SHORT)
                        .show()
                }
        ...
        with(viewModel) {
            with(binding) {
                ...
                if (promptTextFromWeather.isEmpty().not()) {
                    ...
                    Toast.makeText(context, getString(R.string.enter_prompt), Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
